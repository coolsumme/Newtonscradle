...
function setup() {
	...
	rope2=new rope(bobObject2.body,roofObject.body,-bobDiameter*1, 1)
	rope3=new rope(bobObject3.body,roofObject.body,0, 1)
	rope4=new rope(bobObject4.body,roofObject.body,bobDiameter*1, 1)
	rope5=new rope(bobObject5.body,roofObject.body,bobDiameter*2, 1)
